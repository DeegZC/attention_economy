...
info = \
 ...
 {'Caption': "A page peers, with somber curiosity, into a pool of water surrounded by darkness. His reflection absorbs his attention and, like the chiaroscuro style of this painting, creates a stark contrast between that which is and isn't seen. The realism of Caravaggio didn't end with his extensive study of the physical human form given that his tenebrist style reflected the nature of human perception and attention as narrowly focused on few key aspects of the subject.",
  ...
  'Year': 1599},
 {'Caption': 'Marvelously embellished Quranic manuscripts such as the one above epitomized the intimate interrelationship between knowledge, beauty, and the sacred in premodern cultures. As one reads the Quranic script, the elaborate geometric tessellations seemingly emanate forth from the words. Because the Word was the source of beauty, learning was conceived as attending to the beautiful.',
  'File Name': 'Quran',
  'Question': 'Has the disenchantment of modern pedagogy banalized our attention to information?',
  'Source': '17th Century Persian Illuminated Manuscript of Quran, Perkins School of Theology.',
  'Year': 1600},
 {'Caption': 'In what could have been a regal indoor encounter between an erudite cleric and a Mughal prince, a tree – the quintessential symbol of knowledge in the Islamic tradition – sits in between them. Although all members seem to exclusively be attending to each other, their meeting is mediated by the tree, the axis of their gathering both metaphorically and physcially. Before human alienation from the natural environment - as a result of exploitative technologies and concentrated urbanism- and the subsequent need for paying attention to the environment, pre-modern human attention acted through the field of the natural landscape.\n',
  'File Name': 'ScholarTree',
  'Question': 'Can attention to the material ground that subsists human existence only come from living on the ground? ',
  'Source': 'Jalal Quli Khan,\xa0“Scholars and Musicians beneath a Tree, possibly Prince Dara Shikoh and Mulla Shah, Accompanied by Five Retainers, in Kashmir”, India, Mughal dynasty, ca. 1640; Ackland Art Museum, University of North Carolina at Chapel Hill. ',
  'Year': 1640},
 ...
 {'Caption': 'Islamic artforms are formed at the nexus of mathematics and theophany. Here, the concentric rims of design form attentional gradations – akin to the Buddhist meditative stages of realization – representing the stages a spiritual aspirant must struggle through each stage contracting in the number of forms as one moves inward to the center. In emphatic apophatic conclusion, the center becomes blackness of nothingness, the culmination of one’s negative attending – extinguishment.',
  ...
  'Source': 'Taj Mahal Mosaic, Mozaico.',
  'Year': 1650},
 ...
 {'Caption': 'In 1833, The New York Sun ‘shone for all’ at the cost of 1 cent. Grabbing the morning news, finally getting in touch with the happenings of the day, this was a newspaper for the common man. Feeling the newspaper in your hand, the common object which you held was identical to your neighbors.',
  ...
  'Year': 1833},
 {'Caption': 'Many thinkers take the aim of education to be the development of attention. The object of Orientalist fascination, classical Islamic models of early education revolved around the rote memorization of cornerstone texts, most notably the Quran, and recitation of the text back to one’s teacher. Whereas modern western pedagogy appoints the teacher as the orchestrator of various attentional instruments, here, attentiveness is developed though direct and prolonged cognitive combat between student, text, and distraction -  the teacher only supplies occasional artillery support.  ',
  'File Name': 'madrasa',
  'Question': 'Does our ability to attend to text shape our ability to attend to the Other? ',
  'Source': 'Frederick Goodal, "The Madrasa," circa. 1860; Wikipedia Commons',
  'Year': 1860},
 ...
 {'Caption': 'In Russian religious history, the holy fool is a recurring role of the itinerant ascetic, whose suffering parallels that of Christ before them. They often met bleak and untimely deaths, choosing to brave the savage cold, possessionless, until meeting their ends at the heavy hands of mobs or starvation. Asceticism has roots in many other world religions; it is the direction of attention away from all matters of the physical world and towards a stuporous communion with God.',
  ...
  'Year': 1870},
 {'Caption': 'Performed at specific junctures relating to the sun’s visibility, the five daily communal Islamic prayers fashioned a constant collective attentiveness - by ordinary peasants and elites alike - to the diurnal movements of the sun. The prayer thus enchants time, making certain moments greater than others. Today, with the advent of capitalist work cycles and temporally pervasive entertainment consumerism, the five daily prayers stand as a bulwark against the disenchantment of time into 24/7 linearity. ',
  'File Name': 'morning_prayers',
  'Question': 'Does resistance to an exploitative attentional regime require the adoption of another equally aggressive regime? ',
  'Source': 'Auguste Veillon, "Morning Prayers," circa. 1870; Soethby’s. ',
  'Year': 1870},
 ...
 {'Caption': 'Paris in the 1870’s was the origin of a revolution in Western art and imagination. Along came the Impressionists, who imagined the world around them not as a frozen, calculated snapshot of a single moment - like many of their predecessors had - but as a vibrant, moving after-image, imbued with the emotions and atmospheric impressions that would become reified as brush strokes on canvas. The artist’s attention was dislodged from the rut that it had become trapped in; it was free to imagine the experience of the human condition, not just its setting.',
  ...
  'Year': 1879},
 {'Caption': 'The rapid spread of photography after its invention in 1834 allowed for new modes of self-attention. The charisma and allure of this medium was so powerful that even elite Ottoman women committed to the practices of veiling could not resist, with many leaving behind photos in the Ottoman imperial archives. Although there could be little visually striking in the photo itself, the mere act of reifying the body onto an image could give birth to forms of self-meaning– a feeling lost in our image-saturated present.  ',
  'File Name': 'yashmak',
  'Question': 'Is photography a medium for narcissism or a cause for it?  ',
  'Source': 'An Ottoman woman wearing a veil known as a yashmak, Istanbul, 1880’s, Ottoman Imperial Archives.',
  'Year': 1880},
 {'Caption': 'Each image capturing a different movement that makes up the kangaroo jump, the series captures the process as a whole. When captured as a series of images, the artist can see how each body part moves in a way that would not be visible in real-time observation. The still image capture in this situation allows a researcher to pause time in a sense in order to closely observe the phenomenon of a kangaroo jumping.',
  ...
  'Year': 1884},
 {'Caption': 'While Helen Keller lived most of her life blind and deaf, she became a prolific writer and public figure by way of the dedicated mentorship of her lifelong companion Anne Sullivan, who, in the beginning of her literary education taught her new vocabulary by spelling out each word on Keller’s hand – by which she learned over five-hundred words in six months. Due to the attention economies mastery over techniques of visual sensation, discourses on attention often forget the attentional depth possible by touch. Whereas visual stimuli such as images may wrest one’s attention and abandon it in an instant, touch leaves behind a trace of intimacy.  ',
  'File Name': 'Helen_Keller',
  'Question': 'Is true intimacy with the Other bound to touch? ',
  'Source': 'Young Helen Keller Standing next Anne Sullivan while she Spells on her hand, circa. 1888, Perkins School for the Blind.  ',
  'Year': 1888},
 {'Caption': 'In the late 1860’s, the streets and edifices of Paris bore witness to a new kind of advertisement: artistic advertisement posters - larger and more vibrant than ever before - that seemed to pull in any who passed by. Yet, it was only a matter of time before the posters became clutter, covering nearly every available surface in the city and obfuscating the beauty that they were originally conceptualized to productively enhance. An advertising tool whose aesthetic distinctiveness was key to its attention-catching capabilities expanded to fill the space provided until its powers asymptotically reduced to null, and not for the last time.',
  ...
  'Year': 1898},
 {'Caption': 'Because of the imperative to coordinate and synchronize swaths of soldiers across large expanses, World War I catalyzed the full switch from clunky pocket watches to wrist watches – the latter being substantially easier to check while carrying arms. Although the above were worn in the heat of battle, following the war, wrist-watch wearing spread rapidly amongst European men. The act of precisely rendering, parsing, and perennially monitoring time was a part of a new approach to time emergent in modernity: through a more rational, mathematical attentiveness, time, like nature, could be dominated – and used to dominate. ',
  'File Name': 'watches',
  'Question': 'Should one really be taking advantage of every minute? ',
  'Source': 'Cole Pennington, The Ironic Elegance of Trench Watches, Armored watches from World War I, Hodinkee. ',
  'Year': 1900},
 ...
 {'Caption': "Martín Chambi grew up in the rural Andes mountains where houses were arranged around a central communal patio. This photograph has been the center of my dining room wall ever since I can remember. The game they are playing is called sapo and consists of throwing bronze coins at a board hoping to land one in a bronze frog's mouth for maximum points, but the most fun part is gathering the coins back up again like the small child is doing.",
  ...
  'Year': 1925},
 {'Caption': 'Sigmund Freud, the father of psychoanalysis, brought dreams to the fore of modern psychology. Once the site of enchanted transcendent mysteries, dreams in the early twentieth century became the objects of elaborate rationale exegeses, and their inspection by psychoanalysts constituted a new form of self-attention and self-archeology. Modern discourses on dreams have further objectified their status into “content” that can, in some potential future, be recorded or even manipulated. ',
  'File Name': 'Freud',
  'Question': 'Are dreams merely objects of attention or directors of attention? ',
  'Source': 'Sigmund Freud Reading Case Notes, 1930, Getty Images. ',
  'Year': 1930},
 ...
 {'Caption': 'The year is 1935, and the daily newspaper is posted in your neighborhood. Your neighbors, peers, and workers crowding the stand. The headline is shocking.',
  ...
  'Year': 1935},
 {'Caption': 'New forms of mass politics in the nineteenth and twentieth century, such as those which emerged in Nazi Germany, were inextricable from new technology that allowed unprecedented numbers of people to focus attention onto a singular object or human being. Through the charisma of its sheer volume and acoustic ambience, the loudspeaker was one of these technologies that allowed for the capture of mass attention in a singular instant. While propaganda may have been more versatile, few things wrest attention as a live speech delivered by a mesmeric speaker.  ',
  'File Name': 'Hitler',
  'Question': 'Is mass attention the precondition to totalitarianism?  ',
  'Source': 'Nazi leader Adolf Hitler speaks in front of microphones and gestures with his hands, 1935, Getty Images.  ',
  'Year': 1935},
 ...
 {'Caption': 'Glenn Gould was a Canadian classical pianist, renowned for his superlative technique and the richness of his interpretive insights. His performances were known for their near-theatrical atmosphere, as Gould eschewed the stoic conventions of traditional piano performance; he would move his body erratically as he played, often humming along to the notes. He was totally absorbed into his instrument and his craft, as he surrendered body and mind to the music, losing control of his movements while still obsessively focused on perfecting his environment for performance. It could be said that his life and mind became music.',
  ...
  'Year': 1950},
 {'Caption': 'Attracting unprecedented masses to his fiery preaching through new media such as radio and television, Billy Graham is considered perhaps the most influential evangelist to ever march across the plains of Protestant American Christendom. To many, he was an inspiring icon – calling upon people to broaden their fields of attention – amongst a sea of entertainment and celebrity idols seducing the American imagination. Early televangelism thus constituted a form of attentional resistance to the crude sensualism of the attention economy – but, at times, it devolves into an economy of it own.',
  'File Name': 'Graham',
  'Question': 'How can we save our icons from the human propensity for idol-making? \n\n',
  'Source': 'Billy Graham in 1950s, Life and Legacy of Billy Graham. ',
  'Year': 1950},
 ...
 {'Caption': 'One "tank man" is powerless to stop "progress". This photo was taken the day after protests were violently suppressed in Tiananmen square and the tanks are fleeing the scene. In the wake of the massive protests demanding justice, he merely waits on the powerful.',
  ...
  'Year': 1989},
 {'Caption': 'Pre-modern Buddhism situated mediative, attentional practices into a grand cosmology, wherein the self could only be fully realized through its annihilation. The self-centered language of “brain hacking” in post-Buddhist circles represents an ironic inversion of this logic: modern groups interested in utilizing Buddhist meditative rituals for the use of self-improvement. Away from the attended, attention is now about the attender.   ',
  'File Name': 'Meditation',
  'Question': 'Has capitalism turned the practice of being attentive into just another self-marker?',
  'Source': 'How Meditation Rewires Your Brain, 2000, Opulent Mindfulness. ',
  'Year': 2000},
 {'Caption': 'Scholars like Yves Citton who consider the effects of transindividual flows in shaping our individual attentional lives often focus their work on the infrastructure of global media networks. But other flows also exist: Muslims for over a thousand years have practiced the Hajj, migrating and performing rituals in massive flocks with little ritual oversight save the flow of the crowds. The intensity of the collective ambience is such that a number are – unfortunately– trampled to death due to the attentional power of the crowd dynamic.   ',
  'File Name': 'Hajj',
  'Question': 'Can the flows of a spiritual economy offer a form of resistance to capitalist market flows controlling attention? ',
  'Source': 'On Friday The Hajj Pilgrimage Start Begins Here, 2005, Mic. ',
  'Year': 2005},
 {'Caption': 'From the moment he rose to power in 1949, Chairman Mao Zedong made himself the nexus of the inchoate People’s Republic of China. The public was inundated with aggrandizing propaganda, a little red book, and even four different titles for their new leader. The chairman’s power crystallized from the concentrated attention and exaltation of hundreds of millions, all directed towards one man.',
  ...
  'Year': 2006},
 {'Caption': 'While contemporary Quran reciters, continuing the ancient tradition of reciting the Quran before large audiences, have not changed their craft much, their audiences, absorbed in technologically mediated networks of self-image, have. Following a soulful recitation, these listeners perform spectacular feats of affection before the reciter – often with their hand-held phones or cameras documenting the moment. Attentiveness, in a world of constant profile updates, thus becomes performance.  \n',
  'File Name': 'Anwar',
  'Question': 'When is performative attention no longer attentive?  ',
  'Source': '\nEgyptian Devotion to Mahmoud Shahat Anwar, 2011, Shia News Association.  ',
  'Year': 2011},
 ...
 {'Caption': 'The circle, once a symbol of the infinity of the Divine in premodernity, has now mutated in the modern imagination into the form of a refresh loop. Suctions of attention, refresh loops operate on the logic codified by Skinner in which it is merely the potential of reward that conditions our longing to refresh. Not different from how gamblers experience the Zone, affect becomes algorithm.',
  'File Name': 'Cycles',
  'Question': 'How can modernity announce progress yet only leave us in circles, hoping for reward?',
  'Source': 'Refresh Icon, 2021, Online Web Fonts.',
  'Year': 2021},
